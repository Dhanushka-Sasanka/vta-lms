...
<div class="page-wraper" id="main_container">
    ...
    <div class="page-content bg-white">
        ...
        <div class="rev-slider">
            <div class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery36"
                 data-source="gallery" id="rev_slider_486_1_wrapper"
                 style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
                <!-- START REVOLUTION SLIDER 5.3.0.2 fullwidth mode -->
                <div class="rev_slider fullwidthabanner" data-version="5.3.0.2" id="rev_slider_486_1"
                     style="display:none;">
                    <ul>    <!-- SLIDE  -->
                        <li data-description="Science says that Women are generally happier"
                            data-easein="default"
                            ...
                            data-param9="" data-rotate="0"
                            data-saveperformance="off" data-slotamount="default"
                            data-thumb="error-404.html" data-title="A STUDY ON HAPPINESS"
                            ...
                            <div class="tp-caption Newspaper-Title   tp-resizeme"
                                ...
                                WELCOME TO VOCATIONAL TRAINING AUTHORITY OF SRI LANKA
                                <br>
                            ...
                            <div class="tp-caption Newspaper-Button rev-btn "
                                 ...
                                 style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:var(--primary) !important; border:0; border-radius:30px; margin-right:5px; margin-top: 45px">
                                APPLY NOW
                            </div>
                            <div class="tp-caption Newspaper-Button rev-btn"
                                 data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"300","ease":"Power1.easeInOut","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgba(0, 0, 0, 1.00);bg:rgba(255, 255, 255, 1.00);bc:rgba(255, 255, 255, 1.00);bw:1px 1px 1px 1px;"}]'
                                 ...
                                 style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px; margin-top: 45px">
                        ...
                        <li data-description="Science says that Women are generally happier"
                            ...
                            data-param9="" data-rotate="0"
                            data-saveperformance="off" data-slotamount="default"
                            data-thumb="assets/images/slider/slide1.jpg" data-title="A STUDY ON HAPPINESS"
                            data-transition="parallaxvertical">
                            <!-- MAIN IMAGE -->
                            <img alt="" class="rev-slidebg"
                                 data-bgfit="cover"
                            ...
                            <div class="tp-caption Newspaper-Subtitle   tp-resizeme"
                                 ...
                                 style="z-index: 7; white-space: nowrap;text-transform:uppercase; color:#fff; font-family:rubik; font-size:25px; font-weight:500;">
                            ...
                            <div class="tp-caption Newspaper-Subtitle   tp-resizeme"
                                 ...
                                 style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:28px; line-height:20px; font-weight:500;">
                                FOR SRI LANKA FOREIGN EMPLOYMENT BUREAU
                            </div>
                            <!-- LAYER NR. 4 -->
                            <div class="tp-caption Newspaper-Button rev-btn "
                                 data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"300","ease":"Power1.easeInOut","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgba(0, 0, 0, 1.00);bg:rgba(255, 255, 255, 1.00);bc:rgba(255, 255, 255, 1.00);bw:1px 1px 1px 1px;"}]'
                        ...
                        <li data-description="Science says that Women are generally happier"
                            ...
                            data-param9="" data-rotate="0"
                            data-saveperformance="off" data-slotamount="default"
                            data-thumb="assets/images/slider/slide4.jpg" data-title="A STUDY ON HAPPINESS"
                            data-transition="parallaxvertical">
                            <!-- MAIN IMAGE -->
                            <img alt="" class="rev-slidebg"
                                 data-bgfit="cover"
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                <div class="action-box">
                                    <img alt="" src="assets/images/our-services/pic1.jpg">
                                </div>
                                <div class="info-bx text-center">
                                    ...
                                    <a class="btn radius-xl" href="#">View More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                <div class="action-box">
                                    <img alt="" src="assets/images/our-services/pic2.jpg">
                                </div>
                                <div class="info-bx text-center">
                                    <div class="feature-box-sm radius bg-white">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="service-bx m-b0">
                                <div class="action-box">
                                    <img alt="" src="assets/images/our-services/pic3.jpg">
                                </div>
                                <div class="info-bx text-center">
                                    <div class="feature-box-sm radius bg-white">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx left">
                            <h2 class="title-head">CLASSIFICATION <span>OF FIELDS</span></h2>
                            <p>It is a long established fact that a reader will be distracted by the readable content of
                                a page</p>
                        </div>
                    </div>
                    <div class="row" id="popular_courses_section">
                        ...
                        <div class="col-md-12 text-center text-white">
                            ...
                            <form class="cours-search">
                                <div class="input-group">
                                    <input class="form-control" placeholder="What do you want to learn today?	"
                                           type="text">
            ...
            <div class="section-area section-sp2">
                <div class="container">
                    ...
                    <div class="text-center">
                        <a class="btn" href="#">View All Event</a>
                    </div>
                </div>
            </div>
...
<script>
    function getAllCourses() {
        $('#popular_courses_section').empty();
        $.ajax({
            type: "GET",
            url: 'http://127.0.0.1:8000' + '/courses/getAll',
            async: true,
            dataType: "json"
        }).done(function (responce) {

            if (responce['courses']) {
                let courses = responce['courses'];
                ...
                for (let i in courses) {
                    ...
                    let course_type = course['course_type'];
                    let current_cost = course['current_cost'];
                    let rating = course['rating'];
                    let cost = course['cost'];
                    let semester_id = course['semester_id'];
                    // col-md-2 col-lg-3  col-sm-6 m-b30
                    let tableRow = `<div class="col-md-6 col-lg-3 col-sm-6 m-b30">
                                                            <div class="cours-bx">
                                                                <div class="action-box">
                                                                    <img alt="" src="assets/images/courses/pic${Math.floor(Math.random() * 9)}.jpg">
                                                                    <button class="btn" onclick="courseDetailsFetch(${id})" >Read More</button>
                                                                </div>
                                                                <div class="info-bx text-center">
                                                                    <h5><a href="#">${course_name}</a></h5>
                    ...
                    $('#popular_courses_section').append(tableRow);
            ...
            if (responce['events'] !== []) {
                ...
                for (let i in events) {
                    ...
                    let tableRow = ` <div class="col-md-6 col-lg-3 col-sm-6 m-b30">
                                <div class="event-bx">
                                    <div class="action-box">
                                        <img alt="" src="assets/images/event/pic${Math.floor(Math.random() * 3)}.jpg">
                                    </div>
                                    <div class="info-bx d-flex">
                                        <div>
                                            <div class="event-time">
                                                <div class="event-date">${new Date(start).getDay()}</div>
                                        ...
                                        <div class="event-info">
                                            ...
                                            <ul class="media-post">
                                                ...
                                                <li><a href="#"><i class="fa fa-map-marker"></i> Galle Branch</a>
                                                </li>
                                            </ul>
                                            <p style="text-center">${description}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>`;

                    $('#upcoming_events').append(tableRow);
                }
            }
        });
    }
    ...
    function courseDetailsFetch(id) {

        // Get the ID from the data attribute of the button
        ...
        $.ajax({
            url: 'http://127.0.0.1:8000' + '/courses/' + courseId,
            type: 'GET',
            success: function (data) {
                // Step 3: Update the newly loaded HTML page's content

                $('#popular_courses_section').empty();
                console.log(data);
                $('#popular_courses_section').append(`<div class="row d-flex flex-row-reverse">
\t\t\t\t\t\t<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
\t\t\t\t\t\t\t<div class="course-detail-bx">
\t\t\t\t\t\t\t\t<div class="course-price">
\t\t\t\t\t\t\t\t\t<del>${data.cost}</del>
\t\t\t\t\t\t\t\t\t<h4 class="price">${data.current_cost}</h4>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div class="course-buy-now text-center">
\t\t\t\t\t\t\t\t\t<a href="#" class="btn radius-xl text-uppercase">Apply Now</a>
\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t<h2 class="post-title">${data.course_name}</h2>
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-book"></i> <span class="label">Course Type</span> <span class="value">${data.full_time_or_part_time}</span></li>
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-help-alt"></i> <span class="label">Center Name</span> <span class="value">${data.center_name}</span></li>
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-help-alt"></i> <span class="label">Address</span> <span class="value">${data.address}</span></li>
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-help-alt"></i> <span class="label">Contact</span> <span class="value">${data.contact}</span></li>
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-time"></i> <span class="label">Duration</span> <span class="value">${data.month} Months</span></li>
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-stats-up"></i> <span class="label">Skill level</span> <span class="value">${data.nvq}</span></li>
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-smallcap"></i> <span class="label">Language</span> <span class="value">English/Sinhala</span></li>
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-user"></i> <span class="label">Students</span> <span class="value">427</span></li>
\t\t\t\t\t\t\t\t\t\t\t<li><i class="ti-check-box"></i> <span class="label">Level</span> <span class="value">${data.course_type}</span></li>
\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t</div>`);
            ...
            error: function () {
                $('#popular_courses_section').html('<p>Error retrieving data.</p>');
            }
        });
    }
