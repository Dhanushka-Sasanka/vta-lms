<div class="col-xs-1 col-sm-1 col-md-1 col-lg-2 col-xl-2 col-xxl-2 border-rt-e6 px-0 bg-dark " style="min-height: 596px;">
<!-- position-fixed -->
    <div class="d-flex flex-column align-items-center align-items-sm-start ">
                <ul class="nav flex-column pt-2 w-100">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav collapse {{ request()->is('students*')? 'show' : 'hide' }}" id="student-submenu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav collapse {{ request()->is('teachers*')? 'show' : 'hide' }}" id="teacher-submenu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('assignment.list.show')? 'active' : '' }}" href="{{route('assignment.list.show')}}"><i class="bi bi-file-post"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Assignments</span></a>
                    </li><li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('course.mark.list.show')? 'active' : '' }}" href="{{route('course.mark.list.show')}}"><i class="bi bi-cloud-sun"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Marks</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('course.syllabus.index')? 'active' : '' }}" href="{{route('course.syllabus.index')}}"><i class="bi bi-journal-text"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Syllabus</span></a>
                    </li> 
                    ...
                    <li class="nav-item ">
                        ...
                        <ul class="nav collapse {{ request()->is('exams*')? 'show' : 'hide' }}" id="exam-grade-submenu">
